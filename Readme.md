...
# 工作经历
## [宁波艾优生物科技有限公司](http://www.apiyoo.com/)(2019年8月~至今)
> 因为一些原因从乙方到了甲方，工作不仅仅维护升级只之前开发的 “艾优”和“艾尚优品”，同时涉及到了一些钉钉的开发，以及一些团队管理

### [艾优发货]("")
+ 背景:为仓库发货，授权，打包等开发的app，安装在PDA上。
+ 主要职责:独立开发。
+ 使用技术:主要是硬件方面，需要了解不同pda的一些相关参数，同时也涉及到UHF相关开发。
+ 遇到问题:项目度对业务的耦合较高，将功能分出来是比较棘手的。解决方案，1.将基础功能分模块，2.多以Helper方式实现功能，减少对界面的依赖。
+ 收获:对仓库发货流程的熟悉，学习到通过中间类将功能抽象到helper中解耦实际操作，增加抽象。
